...
exports.ShipmentLine = void 0;
const typeorm_1 = require("typeorm");
const entities_1 = require("../../entities");
const entities_2 = require("../../../goods/entities");
const shipment_entity_1 = require("./shipment.entity");
let ShipmentLine = class ShipmentLine extends entities_1.AbstractLineEntity {
};
...
], ShipmentLine.prototype, "shipment", void 0);
__decorate([
...
], ShipmentLine.prototype, "product", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'product_id' }),
    __metadata("design:type", Number)
], ShipmentLine.prototype, "productId", void 0);
__decorate([
...
], ShipmentLine.prototype, "batch", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'batch_id' }),
    __metadata("design:type", Number)
], ShipmentLine.prototype, "batchId", void 0);
exports.ShipmentLine = ShipmentLine = __decorate([
    (0, typeorm_1.Entity)({ name: 'documents_shipmentline' })
], ShipmentLine);
//# sourceMappingURL=shipment-line.entity.js.map