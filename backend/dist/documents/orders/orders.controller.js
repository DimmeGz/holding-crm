...
__decorate([
    ...
    __metadata("design:paramtypes", [query_dto_1.GetOrdersQueryDTO]),
...
__decorate([
    ...
    __param(0, (0, common_1.Param)('orderId', new common_1.ParseIntPipe())),
...
__decorate([
    (0, common_1.Patch)('change-status/:orderId'),
    (0, common_1.UsePipes)(new common_1.ParseIntPipe()),
    __param(0, (0, common_1.Param)('orderId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], OrdersController.prototype, "changeContractStatus", null);
